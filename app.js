...
async function getSongs() {
    ...
    songs.forEach((e) => {
        ...
        box.className = "cards w-[200px] h-[250px] rounded-[0.5rem] bg-[#306567] p-3 flex flex-col justify-between";
        ...
        box.innerHTML = `
            ...
            <div class="w-[100%] flex justify-between items-center bottom-0">
                <button data-audio="${e.songUrl}" class="play-btn text-[1.5rem] cursor-pointer hover:text-[#0bf2e3] transition ease-in-out duration-300">
    ...
    song.forEach((ele) => {
        if (ele.title.toLowerCase().includes(keyword)) {
            ...
            box.innerHTML = `
                ...
                <div class="w-[100%] flex justify-between items-center bottom-0">
                    <button data-audio="${ele.songUrl}" class="play-btn text-[1.5rem] cursor-pointer hover:text-[#1dff0c]">
                        <i class="fa-solid fa-circle-play"></i>
                    </button>
